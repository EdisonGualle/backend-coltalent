...
class CreateContractTypeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'vacation_days_per_year' => 'required|integer|min:1',
            'max_vacation_days' => 'required|integer|min:1|gte:vacation_days_per_year',
            'min_tenure_months_for_vacation' => 'required|integer|min:0',
            'weekly_hours' => "required|integer|min:$weeklyHoursMin|max:$weeklyHoursMax",
        ];
    }
