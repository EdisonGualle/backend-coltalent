...
class UpdateEmployeeRequest extends FormRequest
{
    public function rules()
    {
        ...
        return [
            ...
            'employee.first_name' => 'nullable|string|max:30',
            'employee.second_name' => 'nullable|string|max:30',
            'employee.last_name' => 'nullable|string|max:30',
            'employee.second_last_name' => 'nullable|string|max:30',
            'employee.date_of_birth' => 'nullable|date',
            'employee.gender' => 'nullable|string|max:10',
